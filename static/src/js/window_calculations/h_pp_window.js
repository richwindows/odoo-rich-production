 ...
 */
odoo.define('rich_production.h_pp_window', [], function (require) {
    'use strict';
    ...
    function handleGridCalculations(windowData, fixedgridw, fixedgridh) {
        ...
        console.log('H-PP handleGridCalculations被调用，参数:', {
        ...
        console.log('H-PP handleGridCalculations返回结果:', gridList);
        return gridList;
    }
    ...
    function calculateHPPNailon(widthMm, heightMm, glassType, windowData) {
        console.log('计算H-PP Nailon窗户尺寸:', { widthMm, heightMm, glassType });
        ...
        // 玻璃尺寸计算
        const fixedGlassWidth = widthMm / 2 - 6 - 20.5 * 2 - 3 * 2 - 15 - 3;
        const fixedGlassHeight = heightMm - 20.5 * 2 - 3 * 2 - 15 * 2 - 2;
        ...
        console.log('H-PP Nailon窗户计算结果:', result);
        return result;
    }
    ...
    function calculateHPPStandard(widthMm, heightMm, frameType, glassType, windowData) {
        ...
        // 玻璃尺寸计算
        const fixedGlassWidth = widthMm / 2 - 6 - 20.5 * 2 - 3 * 2 - 3;
        const fixedGlassHeight = heightMm - 20.5 * 2 - 3 * 2 - 2;
